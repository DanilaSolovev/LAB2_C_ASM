...
extern int32_t array_res_asm (int32_t* array_ptr, size_t array_size);
...
int main (void)
{
    ...
    //res = array_res(mas, sizeof(mas)/sizeof(int32_t));
    ...
    volatile int32_t res_asm = 0;
    res_asm = array_res_asm (array_original, sizeof(array_original)/sizeof(int32_t));
    res_asm = array_res_asm (array_originalB, sizeof(array_originalB)/sizeof(int32_t));
    //res_asm = array_res_asm (mas, sizeof(mas)/sizeof(int32_t));
	while (1)
	{
	}
	return 0;
